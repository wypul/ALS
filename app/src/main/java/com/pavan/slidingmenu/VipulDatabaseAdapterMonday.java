 ...
 */
public class VipulDatabaseAdapterMonday extends Activity{
    VipulHelper helper;

    public VipulDatabaseAdapterMonday(Context context){
    ...
    public void checkdb(){
        ...
        //Message.message(this,"Table Dropped");
    ...
    static class VipulHelper extends SQLiteOpenHelper {
        ...
        private static final String TABLE_NAME = "mondaytable";
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            try{
                ...
                db.execSQL("CREATE TABLE tuesdaytable ("+UID+" INTEGER PRIMARY KEY AUTOINCREMENT, "+ROOM_NO+" VARCHAR(255), "+SUBJECT+" VARCHAR(255));");
